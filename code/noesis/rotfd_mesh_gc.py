...
def registerNoesisTypes():
    handle = noesis.register("Revenge Of The Flying Dutchman Mesh",".MESH")
...
def bcLoadModel(data, mdlList):
    ...
    print("vertex group start index: " + str(vertexGroupsStartIndices[0]))
    print("vertex group end index: " + str(vertexGroupsEndIndices[0]))
