...
def readMesh_Z(f,subsectionMatIndices,meshBoneCrc32s=None):
...
pathOne = 'D:\\Program Files (x86)\\THQ\\Disney-Pixar\\Ratatouille\\RatDebug\\DATAS\\P_CELI_M.DPC.out\\objects\\1347548830.Skin_Z'
